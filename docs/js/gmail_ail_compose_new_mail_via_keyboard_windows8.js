var gmail_ail_compose_new_mail_via_keyboard_windows8 = {
    ...
    series: [{
		name: 'firefox',
		data: [
			[Date.UTC(2017, 7, 30), 311.110000],
			[Date.UTC(2017, 7, 30), 333.330000],
			[Date.UTC(2017, 7, 30), 366.670000],
			[Date.UTC(2017, 7, 30), 366.670000],
			...
			[Date.UTC(2017, 8, 1), 611.110000],
			[Date.UTC(2017, 8, 2), 333.330000],
			[Date.UTC(2017, 8, 2), 333.330000],
			...
			[Date.UTC(2017, 8, 3), 344.440000],
			[Date.UTC(2017, 8, 3), 366.670000],
			[Date.UTC(2017, 8, 3), 366.670000],
